...
if choice_sensor == "mnt":
    ...
    #Rotate the dvl
    angle = np.pi/4
    dvl_v_x = (dvl_VE*np.cos(angle) + dvl_VN*np.sin(angle))*np.cos(YAW)*2.1630903586633905
...
if __name__ == '__main__':
    ...
    def display_range():
        ...
        ax1.plot(dvl_T, dvl_BM1R - 116.48084912914656, label = "dvl_BM1R", color = 'red')
        ax1.plot((MBES_mid_T[1:,])[~mask1], (MBES_mid_Z[1:,])[~mask1] - 117.67756491403492, label="MBES_mid_Z")
        ...
        mean_dvlR = (dvl_BM1R + dvl_BM2R + dvl_BM3R + dvl_BM4R)/4 - 116.48084912914656
    ...
    def display_beams_dvl():
        ...
        global dvl_BM3R
        global dvl_BM4R
        dvl_BM1R += -116.48084912914656
        dvl_BM2R += -116.48084912914656
        dvl_BM3R += -116.48084912914656
        dvl_BM4R += -116.48084912914656
    ...
    def display_beams_mbes():
        ...
        #Add the offset
        MBES_min_Z += - 117.67756491403492
        MBES_mid_Z += - 117.67756491403492
        MBES_max_Z += - 117.67756491403492
