...
if __name__ == '__main__':
    ...
    n_particles = 5000#int(input("Number of particles: "))
    ...
    while(time.time() - t_ini < n_sec):
        ...
        ax.scatter(get_average_state(particles)[0],get_average_state(particles)[1], color = 'green', marker='+', label = 'Approximation of particles')
        ...
        im = ax.imshow(Z, interpolation='bilinear', origin='lower',cmap=cm.gray, extent = extent)
