...
if bool_txt:
    ...
    filepath = file_path+"/IMU_final.txt"
...
dvl_VE = dvl["dvl_VE"]/1000. #en mm/s -> m/s
dvl_VN = dvl["dvl_VN"]/1000. #en mm/s -> m/s
dvl_VZ = dvl["dvl_VZ"]/1000. #en mm/s -> m/s
dvl_VSTD = dvl["dvl_VSTD"]/1000. #en mm/s -> m/s
...
if __name__ == '__main__':
    ...
    # ki = 0
    # kd = 1
    # plt.scatter(T[:-1,], kp*ERR[:-1,] + ki*np.cumsum(ERR)[:-1,]*dt + kd*np.diff(ERR)/dt, label = "pid", s = 0.5, color = 'bl')
    # plt.title("speed")
    # plt.xlabel("t [min]")
